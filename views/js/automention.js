        ...
        _renderItem:  function( ul, item ) {
            if(item.img != undefined) {
                return $( "<li></li>" )
                    ...
                    .append( "<a style='display: inline-block; position:relative;' class='user-mention'>" + "<img class='mention' src='" + item.img + "' /><span><span class='small-mention'>@" + item.username + "</span></span></a>")
                    .appendTo( ul );
            }        
            else {    
                return $( "<li></li>" )
                    .data( "item.autocomplete", item )
                    .append( $( "<a></a>" ).text( item.username ) )
                    .appendTo( ul );
            }
        },
